...
class Services(models.Model):
    ...
    logo = models.ImageField(upload_to='logo_services',default='logo_services/default_logo_service.png')
...
class Contact(models.Model) :
    ...
    receiver = models.ForeignKey(Person,on_delete=models.CASCADE,blank=True,null=True)
...
class Replay(models.Model):
    sender = models.ForeignKey(Person,on_delete=models.CASCADE,blank=True,null=True)
